    ...
    for n_point in n_points:
        for n_dim in n_dims:
            ...
            curr_tasks = [
                ...
                Case('Mixer', SpatialMlpConfig(n_out=1, n_layers=model_depth, n_hidden=1024, n_channels=mix_channels), train_args=train_args(train_iters_mix)),
                Case('Transformer (softmax)', TransformerConfig(pos_emb=False, n_out=1, n_layers=model_depth, n_hidden=512, n_mlp_layers=2), train_args=train_args(train_iters_transf)),
