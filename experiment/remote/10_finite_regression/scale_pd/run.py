    ...
    for n_point in n_points:
        for n_dim in n_dims:
            ...
            curr_tasks = [
                ...
                Case('MLP (spatial)', SpatialMlpConfig(n_out=1, n_layers=6, n_hidden=128, n_channels=128, layer_norm=True), train_args=train_args(train_iters)),
                Case('Transformer (softmax)', TransformerConfig(pos_emb=False, n_out=1, n_layers=3, n_heads=2, n_hidden=512, n_mlp_layers=3), train_args=train_args(train_iters)),
...
df.to_pickle(f'res_pd.{run_id}.pkl')
