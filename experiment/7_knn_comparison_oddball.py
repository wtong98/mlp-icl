...
accuracy and logit level on the oddball task.

Things to solidify (top para copied from knn match):
...
# <codecell>
df = pd.read_pickle('remote/7_knn_comparison_oddball/res.pkl')
